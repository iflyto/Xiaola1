...
public class VerificationCodeView extends View {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (widthMode == MeasureSpec.EXACTLY) {
            ...
            isWrapContent=true;
            mWidth=(int)(textPaint.measureText("0")*1.5*codeNum+20+VerifyDisplayUtils.dpToPx(getContext(),8));
        }
        ...
        if (heightMode == MeasureSpec.EXACTLY) {
            ...
            mHeight= (int) VerifyDisplayUtils.dpToPx(getContext(),40);
        }
    ...
    private void initView() {
        ...
        maxTextSize=VerifyDisplayUtils.spToPx(getContext(),50);
        defaultTextSize=VerifyDisplayUtils.spToPx(getContext(),30);
        textPaint=new Paint();
    ...
    private void createCodeBitmap() {
        ...
        if (!isWrapContent){
            ...
            horizontalOffset= (int) ((mWidth-drawWidth-VerifyDisplayUtils.dpToPx(getContext(),8))/2);
    ...
    private void dynamicSetTextPaint(String text){
        int avaiWidth = (int) (mWidth*2.0f/3 - getPaddingLeft() - getPaddingRight() - VerifyDisplayUtils.dpToPx(getContext(), 2));
        if (avaiWidth <= 0) {
            return;
        }
