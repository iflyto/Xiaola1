 ...
 * 饿了么详情样式
 */
public class EleMeHomeDetailActivity extends AppCompatActivity {
    ...
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eleme_home_detail);

        mRecyclerView = (RecyclerView) findViewById(R.id.recyclerView);
        mViewPager = (ViewPager) findViewById(R.id.viewpager);
        mZoomHeader = (ZoomHeaderView) findViewById(R.id.zoomHeader);
        mViewPager.setAdapter(new QAdapter());
        ...
        mRecyclerView.setAdapter(new EleMeListAdapter());
    ...
    class QAdapter extends PagerAdapter {
        public QAdapter() {
            views = new ArrayList<>();
            views.add(View.inflate(EleMeHomeDetailActivity.this, R.layout.item_img, null));
            views.get(0).findViewById(R.id.btn_buy).setOnClickListener(new View.OnClickListener() {
                @Override public void onClick(View v) {
                    Toast.makeText(EleMeHomeDetailActivity.this, "buy", Toast.LENGTH_SHORT).show();
                }
            });
            views.add(View.inflate(EleMeHomeDetailActivity.this, R.layout.item_img, null));
