        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!TextUtils.isEmpty(input)&&input.equals(code)){
                    Toast.makeText(VerifyDataActivity.this,"Verify Success!Welcome",Toast.LENGTH_SHORT).show();
                }else {
                    Toast.makeText(VerifyDataActivity.this,"Verification code error!Try Again",Toast.LENGTH_SHORT).show();
                }
            }
        });
